...
public class Config
{
    ...
    [Description("Enable/Disable the CreditTag system. We're working free on the plugins so please don't turn this off, we deserve this! :)")] 
    public bool CreditTagSystem { get; set; } = false;
